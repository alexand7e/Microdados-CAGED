...
class CagedUtils:
    ...
    def classificar_regiao(self, codigo_ibge=None):
        regioes = {
        ...
        # Verificando se o código do IBGE é um dígito e está nos estados classificados
        if isinstance(codigo_ibge, int):
            for regiao, estados in regioes.items():
                if codigo_ibge in estados:
                    return regiao
